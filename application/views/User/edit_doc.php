...
<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
    ...
    <div class="form-group">
        Part Of Fun: <input type="radio" name="part_of_fun" value="Yes" /<?php if ($row->part_of_fun == 'Yes') {
            echo "checked";
        } ?>>  YES
        <input type="radio" name="part_of_fun" value="No"  <?php if ($row->part_of_fun == 'No') {
            echo "checked";
        } ?>  >No
    </div>
