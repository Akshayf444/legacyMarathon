    ...
    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <div class="row">
            <div class="form-group">
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                    No Of Taxi Tour
                    <input type="number" class="form-control" value="" name="Taxi_Tour" placeholder="No of Taxi Tour " /></div>
                ...
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4 leftpad">
                    Chemist Count
                    <input type="number" class="form-control" value="" name="chemist_taxi" placeholder="Chemist Count" />
        ...
        <div class="row">
            <div class="form-group">
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                    No Of Bike Tour
                    <input type="number" class="form-control" value="" name="bike_tour" placeholder="No of Bike Tour " /></div>
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4 leftpad">
                    Location
                    <input type="text" class="form-control" value="" name="Location_bike" placeholder="Location" /></div>
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4 leftpad">
                    Chemist Count
                    <input type="number" class="form-control" value="" name="chemist_bike" placeholder="Chemist Count" /> </div> 
            </div>
        </div><br>
