...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?php echo $row->ASTHALIN_DPI ?>" name="ASTHALIN_DPI" placeholder="POB  Of ASTHALIN DPI"/> </div>
        <div class="form-group">
            <label>POB Of AEROCORT FORTE ROTACAPS</label>
            <input type="text"  class="form-control" name="AEROCORT_FORTE_ROTACAPS" value="<?php echo $row->AEROCORT_FORTE_ROTACAPS ?>" placeholder="POB Of AEROCORT FORTE ROTACAPS" >
        </div>	    
        <div class="form-group">
            <label>POB Of AEROCORT ROTACAPS</label>
            <input type="text"  class="form-control" name="AEROCORT_ROTACAPS" value="<?php echo $row->AEROCORT_ROTACAPS ?>"required="" placeholder="POB Of AEROCORT ROTACAPS" >
        </div>	
        <div class="form-group">
            <label>POB Of AEROCORT MDI</label>
            <input type="text"  class="form-control" name="AEROCORT_MDI" value="<?php echo $row->AEROCORT_MDI; ?>" placeholder="POB Of AEROCORT MDI" >
        </div>	
        <div class="form-group">
