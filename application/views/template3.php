                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu" style="display: none;">
                                <?php
                                if ($this->session->userdata('Designation') == 'TM') {
                                    echo '<li><a href="' . site_url('User/addchemist') . '"><i class="fa fa-circle-o"></i> Add Doctor</a></li>';
                                }
                                ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu" style="display: none;">
                                <?php
                                if ($this->session->userdata('Designation') == 'TM') {
                                    echo '<li><a href="' . site_url('User/SCAT') . '"><i class="fa fa-circle-o"></i> Add Doctor</a></li>';
                                }
                                ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu" style="display: none;">
                                <?php
                                if ($this->session->userdata('Designation') == 'TM') {
                                    echo '<li><a href="' . site_url('User/tour') . '"><i class="fa fa-circle-o"></i> Add Doctor</a></li>';
                                }
                                ?>
                                <li class=""><a href="<?php echo site_url('User/view_tour'); ?>"><i class="fa fa-circle-o"></i>  View Doctor</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
